define(["app", "hbs!apps/adendasCas/adendas/templates/inicio_adendas",
    "apps/adendasCas/adendas/view/listar_contratos_cas" ,
   /* "apps/contratosCas/contratos/view/listar_plazas" ,
    ...
    function (ErzaManager,inicio_adendasTemp,
              ListarContratosCasView
             /* ListarServidorCasView,
              ListarCargosView,
              ListarPlazasView,
              updatePlazasModel,
              insertContratoAdendasModel,
              insertPlazasHistorialModel,
              ver_servidor_itemModel,
              updateServidorItemModel,
              insertServidorItemModel*/
              ) {

    ErzaManager.module('AdendasApp.Form.View', function (View, ErzaManager, Backbone, Marionette, $, _) {

        View.Layout = Marionette.Layout.extend({
            template: inicio_adendasTemp,
            ListarContratosCasView: new ListarContratosCasView(),
           /* ListarServidorCasView: new ListarServidorCasView(),
            ...
            events: {
               // "click #list_cont_cas": "llamarModalListarContCas"
            ...
            onRender: function () {
                this.initialFetch();
                this.llamarModalListarContCas();
                this.ListarReg.show(this.ListarContratosCasView);
               // this.ListarPlaz.show(this.ListarPlazasView);

            },

            initialFetch: function(){
                this.ListarContratosCasView.fetchContratos();
            ...
            llamarModalListarContCas:function(){

                var self=this;
                self.udid=10225;
                self.ListarContratosCasView.fetchContratos(self.udid,function () {


                    if(self.ListarContratosCasView.collection.length!=0){
                        ...
                        $('#tabla-contratos_wrapper').append("<div id='footer-table'></div>");
                        $('#tabla-contratos_next').html("<i  class='glyphicon glyphicon-forward'></i>");
                        $('#tabla-contratos_previous').html("<i class='glyphicon glyphicon-backward'></i>");
...
*/
    ...
    return ErzaManager.AdendasApp.Form.View;
});
